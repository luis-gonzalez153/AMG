<template>
    <div>
        <v-card>
            <v-card-title>Registro de Cita</v-card-title>
            <v-card-text>
                <v-form>
                    <v-container>
                        <v-card
                            class="my-3"
                        >
                            <v-card-title>Detalles de Cita</v-card-title>
                            <v-card-text>
                                <v-row>
                                    <v-col
                                        class="py-0"
...
<script>
    ...
    import FormularioProfesion from "../cita/FormularioProfesion.vue";
    import FormularioAreaLaboral from "../cita/FormularioAreaLaboral.vue";
        ...
        methods:{
            registrarCiudadano(){
                db.collection("ciudadanos").doc().set(
                    ...
                    Swal.fire({
                        title:"Exito!",
                        text:"Se registro el cita correctamente",
                        icon:"success",
            ...
            agregarInfoLaboral(){
                this.cita["informacion_laboral"].push({
            ...
            eliminarInfoLaboral(index_info){
                this.cita["informacion_laboral"] = this.cita["informacion_laboral"].filter((item, index) => index !== index_info);
            },
